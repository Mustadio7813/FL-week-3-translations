...
translate spanish strings:
    ...
    old "Audio Filename:"
    new "Nombre de archivo de audio:"
    ...
    new "Este programa contiene software gratuito bajo varias licencias, incluida la licencia MIT y la licencia pública general reducida de GNU. Puede encontrar una lista completa de software, incluidos enlaces al código fuente completo, {a=https://www.renpy.org/l/license}aquí{/a}."
    ...
    new "tiempo de reenvío automático"
    ...
    new "espaciado de línea de fuente"
    ...
    new "Voz del portapapeles habilitada. Presiona 'shift+C' para deshabilitar."

    # renpy/common/00preferences.rpy:618
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "La voz propia diría \"[renpy.display.tts.last]\". Presiona 'alt+shift+V' para deshabilitar."
    ...
    new "Este proyecto no admite la actualización o se eliminó el archivo de estado de actualización."
    ...
    new "Sus controladores de gráficos pueden estar desactualizados o no funcionar correctamente. Esto puede conducir a una visualización de gráficos lenta o incorrecta."
